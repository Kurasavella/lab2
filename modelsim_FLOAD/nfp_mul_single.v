// -------------------------------------------------------------
// 
// File Name: hdlsrc\Fload\nfp_mul_single.v
// Created: 2023-04-05 23:03:46
// 
...
// Source Path: Fload/CALC_MAGNITUDE_AND_PHASE_FLOAT_POINT/nfp_mul_single
// Hierarchy Level: 1
// 
...
module nfp_mul_single
  ...
  reg  [0:3] Delay8_reg_1;  // ufix1 [4]
  wire [0:3] Delay8_reg_next_1;  // ufix1 [4]
  wire Delay8_out1_2;
  ...
  wire signed [9:0] Delay4_reg_next [0:3];  // sfix10 [4]
  ...
  always @(posedge I_CLK or negedge I_RST_N)
    begin : Delay8_1_process
      if (I_RST_N == 1'b0) begin
        Delay8_reg[0] <= 42'h00000000000;
        Delay8_reg[1] <= 42'h00000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge I_CLK or negedge I_RST_N)
    begin : Delay6_1_process
      if (I_RST_N == 1'b0) begin
        Delay6_reg[0] <= 26'b00000000000000000000000000;
        Delay6_reg[1] <= 26'b00000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge I_CLK or negedge I_RST_N)
    begin : Delay5_process
      if (I_RST_N == 1'b0) begin
        Delay5_reg[0] <= 26'b00000000000000000000000000;
        Delay5_reg[1] <= 26'b00000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge I_CLK or negedge I_RST_N)
    begin : Delay3_3_process
      if (I_RST_N == 1'b0) begin
        Delay3_reg[0] <= 26'b00000000000000000000000000;
        Delay3_reg[1] <= 26'b00000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Delay8_reg_next_1[0] = Logical_Operator2_out1_1;
  ...
  always @(posedge I_CLK or negedge I_RST_N)
    begin : Delay4_3_process
      if (I_RST_N == 1'b0) begin
        Delay4_reg[0] <= 10'sb0000000000;
        Delay4_reg[1] <= 10'sb0000000000;
        Delay4_reg[2] <= 10'sb0000000000;
        Delay4_reg[3] <= 10'sb0000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Delay4_out1_3 = Delay4_reg[3];
  assign Delay4_reg_next[0] = Switch2_out1_1;
