// -------------------------------------------------------------
// 
// File Name: hdlsrc\Fixed\nfp_convert_sfix_32_En11_to_single.v
...
// -------------------------------------------------------------
// 
// Module: nfp_convert_sfix_32_En11_to_single
// Source Path: Fixed/CALC_MAGNITUDE_AND_PHASE_FIXED_POINT/nfp_convert_sfix_32_En11_to_single
// Hierarchy Level: 1
// 
...
module nfp_convert_sfix_32_En11_to_single
  ...
  input   I_RST_N;
  input   enb;
  input   signed [31:0] nfp_in;  // sfix32_En11
  output  [31:0] nfp_out;  // ufix32


  reg signed [31:0] Delay_out1;  // sfix32_En11
  ...
  wire [31:0] Delay_out1_dtc;  // ufix32_En11
  wire signed [32:0] Unary_Minus_cast;  // sfix33_En11
  wire signed [32:0] Unary_Minus_cast_1;  // sfix33_En11
  wire signed [31:0] Unary_Minus_out1;  // sfix32_En11
  wire [31:0] Unary_Minus_out1_dtc;  // ufix32_En11
  wire [31:0] Switch_out1;  // ufix32_En11
  ...
  assign CompareToZero1_out1 = Delay_out1 == 32'sb00000000000000000000000000000000;
  ...
  assign Compare_To_Zero_out1 = Delay_out1 < 32'sb00000000000000000000000000000000;
  ...
  assign Unary_Minus_cast = {Delay_out1[31], Delay_out1};
  assign Unary_Minus_cast_1 =  - (Unary_Minus_cast);
  assign Unary_Minus_out1 = Unary_Minus_cast_1[31:0];
  ...
  assign Data_Type_Conversion_out1 = {96'b0, Switch_out1};
...
endmodule  // nfp_convert_sfix_32_En11_to_single
